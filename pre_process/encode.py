#encode
import torch, math
from transformers import BertTokenizer, XLNetTokenizer, RobertaTokenizer, LongformerTokenizer, AutoTokenizer, AutoModelForMaskedLM
import logging

log = logging.getLogger()


def encode_documents(documents: list, tokenizer, max_input_length):# 輸入是文檔，DOC的話是512，而lstm是根據不同的chunk_size
