...
from model.multi_bert_moose_q3_qx_visual import multiBert as Model
# from model.multi_bert_moose_q3_qx import multiBert as Model
...
def train(
    ...
    tensors = load_file(f"ckpts/moose_q3-qx/meanvar_base_kv_prompt_{test_prompt_id}/{ckpts[test_prompt_id-1]}/model.safetensors")
    ...
    print('Testing is using device:', trainer.args.device)
